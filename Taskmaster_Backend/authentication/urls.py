...
from .views import CurrentUserView,PasswordResetConfirmView,UserUpdateView,UdatContraseñaView
...
urlpatterns = [
    ...
    path('contra/<int:pk>/update/',UdatContraseñaView.as_view(),name='actualizar-contraseña'),
]
