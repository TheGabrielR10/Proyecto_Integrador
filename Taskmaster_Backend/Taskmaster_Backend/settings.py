...
SECRET_KEY = 'django-insecure-zvs@&bis_)ts&^9l=zdvrr$_2+cn-j$i%155rpyx!o^s++!&xa'
...
EMAIL_HOST_PASSWORD = 'xxx xxxx xxxx xxxx'#Se debe crear contraseña de aplicaicon desde gmail y tener habilitado la dble autenticacion (la quito por seguridad Profe)
